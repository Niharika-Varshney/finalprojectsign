...
def asl_page():
    ...
    return render_template('index1.html', language="AMERICAN SIGN LANGUAGE")
...
def ssl_page():
    ...
    current_labels_dict = labels_dict
    return render_template('index1.html', language="SPANISH SIGN LANGUAGE")
...
def bsl_page():
    ...
    current_labels_dict = labels_dict
    return render_template('index1.html', language="BRITISH SIGN LANGUAGE")
...
def isl_page():
    ...
    current_labels_dict = labels_dict
    return render_template('index1.html', language="INDIAN SIGN LANGUAGE")
